...
import MalwareAnalyses from "src/views/monitoring/malware/MalwareAnalysis";
...
const Router = [
  {
    ...
    children: [
      ...
      { path: '/monitoring/malware-analysis', element: <MalwareAnalyses /> },
      { path: '/monitoring/malware-analysis/:malwareAnalysisId', element: <MalwareAnalyses /> },
      { path: '/monitoring/siem', element: <SIEMMonitoring /> },
