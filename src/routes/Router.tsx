...
const Router = [
  {
    ...
    children: [
      ...
      { path: '/compliance/groups/:groupId', element: <GroupDetails />, roles: ['Admin', 'Defender'] },
      { path: '/compliance/groups/create', element: <CreateGiottoGroup />, roles: ['Admin', 'Defender'] },
      { path: '/compliance/groups/edit/:groupId', element: <EditGiottoGroup />, roles: ['Admin', 'Defender'] },
