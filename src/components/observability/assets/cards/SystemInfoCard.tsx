...
const SystemInfoCards = ({ id }: SystemInfoCardsProps) => {
  ...
  const pcInfo = [
    ...
    { label: t('observability.manufacturer'), value: observedAssetsDetail?.cpuInfo.PCInfo.Manufacturer },
    { label: t('observability.serial_number'), value: observedAssetsDetail?.cpuInfo.PCInfo.SerialNumber },
  ];

  const cpuInfo = [
    { label: t('observability.name'), value: observedAssetsDetail?.cpuInfo.CpuInfo.Name },
    { label: t('observability.processor_id'), value: observedAssetsDetail?.cpuInfo.CpuInfo.ProcessorId },
    { label: t('observability.architecture'), value: observedAssetsDetail?.cpuInfo.CpuInfo.Architecture },
    { label: t('observability.core_count'), value: observedAssetsDetail?.cpuInfo.CpuInfo.NumberOfCores.toString() },
    { label: t('observability.logical_processors'), value: observedAssetsDetail?.cpuInfo.CpuInfo.NumberOfLogicalProcessors.toString() },
    { label: t('observability.max_clock_speed'), value: observedAssetsDetail?.cpuInfo.CpuInfo.MaxClockSpeed },
    { label: t('observability.socket_count'), value: observedAssetsDetail?.cpuInfo.CpuInfo.NumberOfSockets.toString() },
    { label: t('observability.service_count'), value: observedAssetsDetail?.cpuInfo.CpuInfo.ServicesCount.toString() },
  ];

  const ramInfo = [
    { label: t('observability.total_physical_memory'), value: observedAssetsDetail?.cpuInfo.RamInfo.TotalPhysicalMemory.toString() },
    { label: t('observability.free_physical_memory'), value: observedAssetsDetail?.cpuInfo.RamInfo.FreePhysicalMemory.toString() },
    { label: t('observability.used_physical_memory'), value: observedAssetsDetail?.cpuInfo.RamInfo.UsedPhysicalMemory.toString() },
  ];
  ...
  const osInfo = [
    { label: t('observability.os_name'), value: observedAssetsDetail?.cpuInfo.OSInfo.OperatingSystem },
    { label: t('observability.version'), value: observedAssetsDetail?.cpuInfo.OSInfo.Version },
    { label: t('observability.build_number'), value: observedAssetsDetail?.cpuInfo.OSInfo.BuildNumber },
    { label: t('observability.build_type'), value: observedAssetsDetail?.cpuInfo.OSInfo.BuildType },
    { label: t('observability.manufacturer'), value: observedAssetsDetail?.cpuInfo.OSInfo.Manufacturer },
    { label: t('observability.registered_user'), value: observedAssetsDetail?.cpuInfo.OSInfo.RegisteredUser },
    { label: t('observability.system_directory'), value: observedAssetsDetail?.cpuInfo.OSInfo.SystemDirectory },
    { label: t('observability.installation_date'), value: observedAssetsDetail?.cpuInfo.OSInfo.InstallDate },
    { label: t('observability.architecture'), value: observedAssetsDetail?.cpuInfo.OSInfo.Architecture },
  ];
