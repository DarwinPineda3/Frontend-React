            ...
            <Box>
              ...
              <Accordion defaultExpanded>
                ...
                <AccordionDetails>
                  ...
                  <Typography variant="body2">{t('installation_guide.windows.notes')}</Typography>
                </AccordionDetails>
              </Accordion>
              ...
              <Accordion defaultExpanded>
                <AccordionSummary expandIcon={<ExpandMoreIcon />}>
                  <Typography variant="h6">
                    <FaLinux style={{ marginRight: '8px' }} /> {t('installation_guide.linux.title')}
                  </Typography>
                </AccordionSummary>
                <AccordionDetails>
                  <Typography variant="h6">
                  ...
                  <Box sx={{ padding: 2 }}>
                    ...
                    {value === 4 && (
                      <CodeBlock
                        onClick={() => copyToClipboard(`sudo zypper install unzip sysstat`)}
                      >
                  ...
                  <Typography variant="h6" sx={{ marginTop: 2 }}>
                    {t('installation_guide.linux.error_notes.title')}
                  </Typography>
