...
const SentimentAnalysisChart: React.FC<SentimentAnalysisChartProps> = ({ social_networks_sentiment_analysis_chart }) => {
    ...
    return (
        <DashboardCard title="Sentiment Analysis for social network">
